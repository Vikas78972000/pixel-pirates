  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50">
      <div className="max-w-4xl mx-auto px-4 py-12">
          {/* Resume Skill Extractor Section */}
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
            ...
            {backendStatus ? (
              <div className="bg-green-50 p-4 rounded-md">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-green-700">
                    App Name: {backendStatus.app_name}
                  </p>
                  <p className="text-green-700">
          ...
          <div className="p-6 border-b border-gray-100 bg-green-50">
            ...
            <p className="text-gray-600">
              If you're seeing this page, your GUVI Hackathon FSD Setup frontend
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="bg-green-50 p-4 rounded-md text-gray-800 mt-4">
              <p>
                Try adding a new page or component to see how everything works
                together. The changes will automatically refresh in your
                browser!
              </p>
            </div>
          </div>
          ...
          <div className="p-6 border-b border-gray-100">
            ...
            <div className="bg-gray-50 p-4 rounded-md">
              ...
              <p className="mt-2 text-sm text-gray-600">
                This will build your project and guide you through the
                deployment process.
              </p>
            </div>
          </div>
          ...
          <div className="p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-3 gap-3">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block p-3 bg-teal-50 rounded-md hover:bg-teal-100 transition-colors"
              >
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block p-3 bg-emerald-50 rounded-md hover:bg-emerald-100 transition-colors"
              >
                <h3 className="font-medium text-gray-900 mb-1">Netlify Docs</h3>
                <p className="text-xs text-gray-600">Frontend hosting</p>
              </a>
              <a
                href="https://hackathon.guvi.in?hackathon-id=asdasd-asd-asd-sadsad"
                target="_blank"
                rel="noopener noreferrer"
                className="block p-3 bg-amber-50 rounded-md hover:bg-amber-100 transition-colors"
              >
        ...
        <div className="mt-8 text-center">
          ...
          <p className="text-gray-500 mt-2">
            Start building your amazing frontend application!
          </p>
        </div>
      </div>
    </div>
